...
def preprocess_train_data():
    ...
    stem_words, tag_classes, pattern_word_tags_list = create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words)
    ...
    train_y = class_label_encoding(tag_classes, pattern_word_tags_list)
